...
# and 
# https://github.com/tiangolo/uwsgi-nginx-flask-docker/blob/master/docker-images/entrypoint.sh
...
if [ -f /app/nginx.conf ]; then
    # A: static nginx config
    cp /app/nginx.conf /etc/nginx/nginx.conf
else
    # B: dynamic nginx config configurable through env variables
    content='user  nginx;\n'
    ...
    content_server=$content_server"    location = /favicon.ico {\n"
    content_server=$content_server"        access_log off; log_not_found off;\n"
